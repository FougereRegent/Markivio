...
public class ArticleRepository(MarkivioContext context, IDbContextFactory<MarkivioContext> factory) : GenericRepositpory<Article>(context, factory), IArticleRepository
{
