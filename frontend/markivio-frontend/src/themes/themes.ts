...
const MyPreset = definePreset(Aura, {
  semantic: {
    colorScheme: {
      ...
      dark: {
        primary: {
          50: 'var(--primary-color-50-dark)',
          100: 'var(--primary-color-100-dark)',
          200: 'var(--primary-color-200-dark)',
          300: 'var(--primary-color-300-dark)',
          400: 'var(--primary-color-400-dark)',
          500: 'var(--primary-color-500-dark)',
          600: 'var(--primary-color-600-dark)',
          700: 'var(--primary-color-700-dark)',
          800: 'var(--primary-color-800-dark)',
          900: 'var(--primary-color-900-dark)',
          950: 'var(--primary-color-950-dark)',
        },
        surface: {
